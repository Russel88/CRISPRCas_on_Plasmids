...
cat <(awk '{print $2,$1,$3,$4,$9+1,$20,$21}' CRISPRs/Archaea/crisprs_final_typed.tab) <(awk -F'\t' '{print $2,$1,$3,$4,$7}' CRISPRs/Archaea/RepeatMatch/arrays_sub.tab) <(awk '{print $2,$1,$3,$4,$9+1,$20,$21}' CRISPRs/PLSDB/crisprs_final_typed.tab) <(awk -F'\t' '{print $2,$1,$3,$4,$7}' CRISPRs/PLSDB/RepeatMatch/arrays_sub.tab) > Collect/CRISPR_plasmid.tab
cat <(awk '{print $2,$1,$3,$4,$9+1,$20,$21}' CRISPRs/Archaea_Hosts/crisprs_final_typed.tab) <(awk -F'\t' '{print $2,$1,$3,$4,$7}' CRISPRs/Archaea_Hosts/RepeatMatch/arrays_sub.tab) <(awk '{print $2,$1,$3,$4,$9+1,$20,$21}' CRISPRs/Hosts/crisprs_final_typed.tab) <(awk -F'\t' '{print $2,$1,$3,$4,$7}' CRISPRs/Hosts/RepeatMatch/arrays_sub.tab) > Collect/CRISPR_host.tab
