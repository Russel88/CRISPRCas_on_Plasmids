...
criscas_a$SubType <- factor(criscas_a$SubType, levels = c("A", "A1", "A2", "A3", "B", "B1", "C", "D", "E", "F", "F_T", "G", "J", "K", "Hybrid"))
...
p
ggsave(p, file = "Figures/Fig1a.pdf", width = 12, height = 8, units = "cm")
write.csv(criscas_a[criscas_a$Origin == "Plasmid", c("Type", "SubType", "Prediction")], file = "Figures/Fig1a.csv", quote = FALSE, row.names = FALSE)
...
p
ggsave(p, file = "Figures/Fig1a_chromosome.pdf", width = 12, height = 8, units = "cm")
write.csv(criscas_a[criscas_a$Origin == "Plasmid", c("Type", "SubType", "Prediction")], file = "Figures/Fig1a_chromosomes.csv", quote = FALSE, row.names = FALSE)
...
p <- ggplot(prev, aes(Type, Prevalence, fill = Type)) +
    ...
    coord_flip()
p
ggsave(p, file = "Figures/Fig1b_1.pdf", width = 20, height = 6, units = "cm")
write.csv(prev[, c("Type", "Origin", "Prevalence")], file = "Figures/Fig1b_1.csv", quote = FALSE, row.names = FALSE)
...
ggsave(p, file = "Figures/Fig1b_2.pdf", width = 16, height = 5, units = "cm")
write.csv(prevN[, c("Type", "Origin", "Prevalence")], file = "Figures/Fig1b_2.csv", quote = FALSE, row.names = FALSE)
